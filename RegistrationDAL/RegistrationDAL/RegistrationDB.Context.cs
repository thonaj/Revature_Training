...
namespace RegistrationDAL
{
    ...
    public partial class RegistrationDBEntities1 : DbContext
    {
        ...
        [DbFunction("RegistrationDBEntities1", "fn_class_schedule")]
        public virtual IQueryable<fn_class_schedule_Result> fn_class_schedule(Nullable<int> classnum)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_class_schedule_Result>("[RegistrationDBEntities1].[fn_class_schedule](@classnum)", classnumParameter);
        }
    
        [DbFunction("RegistrationDBEntities1", "fn_student_schedule")]
        public virtual IQueryable<fn_student_schedule_Result> fn_student_schedule(Nullable<int> studentnum)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_student_schedule_Result>("[RegistrationDBEntities1].[fn_student_schedule](@studentnum)", studentnumParameter);
        }
